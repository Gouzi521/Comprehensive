package com.ma.pingan.comprehensive.widget;
...
public class ShadeTabView extends FrameLayout {
     ...
     * 选中状态下底部文字默认颜色
     */
    private final String DEFAULT_SELECT_TEXT_COLOR = "#2da0d2";

    private float alpha;

    public ShadeTabView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
